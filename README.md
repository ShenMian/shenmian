...
- [Fris0uman/CDDA-Soundpacks](https://github.com/Fris0uman/CDDA-Soundpacks) - A continuation of the CO.AG soundpack initiated by SkyBreach (5 days ago)
- [codetechandtutorials/openal-impl](https://github.com/codetechandtutorials/openal-impl) - An example of using the OpenAL sound library. (5 days ago)

<details><summary>more...</summary>

1. [Fris0uman/CDDA-Soundpacks](https://github.com/Fris0uman/CDDA-Soundpacks) - A continuation of the CO.AG soundpack initiated by SkyBreach (5 days ago)
1. [codetechandtutorials/openal-impl](https://github.com/codetechandtutorials/openal-impl) - An example of using the OpenAL sound library. (5 days ago)
...
- [pepperoni21/ollama-rs](https://github.com/pepperoni21/ollama-rs) ([v0.2.5](https://github.com/pepperoni21/ollama-rs/releases/tag/v0.2.5), 1 day ago) - A simple and easy-to-use library for interacting with the Ollama API.
...
1. [pepperoni21/ollama-rs](https://github.com/pepperoni21/ollama-rs) ([v0.2.5](https://github.com/pepperoni21/ollama-rs/releases/tag/v0.2.5), 1 day ago) - A simple and easy-to-use library for interacting with the Ollama API.
