...
- [Lommix/bevy_hui](https://github.com/Lommix/bevy_hui) - Component based UI crate using Xml/Html with focus on hot reload for the bevy engine. (1 day ago)
- [rust-lang/async-book](https://github.com/rust-lang/async-book) - Asynchronous Programming in Rust (5 days ago)

<details><summary>more...</summary>

1. [Lommix/bevy_hui](https://github.com/Lommix/bevy_hui) - Component based UI crate using Xml/Html with focus on hot reload for the bevy engine. (1 day ago)
1. [rust-lang/async-book](https://github.com/rust-lang/async-book) - Asynchronous Programming in Rust (5 days ago)
...
1. [ratatui/ratatui](https://github.com/ratatui/ratatui) - A Rust crate for cooking up terminal user interfaces (TUIs) 👨‍🍳🐀 https://ratatui.rs (2 weeks ago)
...
- [build(deps): update bevy to v0.15](https://github.com/ShenMian/sokoban-rs/pull/15) on [ShenMian/sokoban-rs](https://github.com/ShenMian/sokoban-rs) (2 days ago)
- [tracker: Add version 0.1.1](https://github.com/ScoopInstaller/Extras/pull/14548) on [ScoopInstaller/Extras](https://github.com/ScoopInstaller/Extras) (6 days ago)
...
1. [build(deps): update bevy to v0.15](https://github.com/ShenMian/sokoban-rs/pull/15) on [ShenMian/sokoban-rs](https://github.com/ShenMian/sokoban-rs) (2 days ago)
1. [tracker: Add version 0.1.1](https://github.com/ScoopInstaller/Extras/pull/14548) on [ScoopInstaller/Extras](https://github.com/ScoopInstaller/Extras) (6 days ago)
...
- [jomaway/typst-gentle-clues](https://github.com/jomaway/typst-gentle-clues) ([v1.1.0](https://github.com/jomaway/typst-gentle-clues/releases/tag/v1.1.0), 1 day ago) - Simple admonishment for typst
- [ShenMian/tracker](https://github.com/ShenMian/tracker) ([v0.1.2](https://github.com/ShenMian/tracker/releases/tag/v0.1.2), 2 days ago) - A terminal-based real-time satellite tracking and orbit prediction application.
...
1. [jomaway/typst-gentle-clues](https://github.com/jomaway/typst-gentle-clues) ([v1.1.0](https://github.com/jomaway/typst-gentle-clues/releases/tag/v1.1.0), 1 day ago) - Simple admonishment for typst
1. [ShenMian/tracker](https://github.com/ShenMian/tracker) ([v0.1.2](https://github.com/ShenMian/tracker/releases/tag/v0.1.2), 2 days ago) - A terminal-based real-time satellite tracking and orbit prediction application.
