...
- [Fris0uman/CDDA-Soundpacks](https://github.com/Fris0uman/CDDA-Soundpacks) - A continuation of the CO.AG soundpack initiated by SkyBreach (6 days ago)
- [codetechandtutorials/openal-impl](https://github.com/codetechandtutorials/openal-impl) - An example of using the OpenAL sound library. (6 days ago)

<details><summary>more...</summary>

1. [Fris0uman/CDDA-Soundpacks](https://github.com/Fris0uman/CDDA-Soundpacks) - A continuation of the CO.AG soundpack initiated by SkyBreach (6 days ago)
1. [codetechandtutorials/openal-impl](https://github.com/codetechandtutorials/openal-impl) - An example of using the OpenAL sound library. (6 days ago)
...
1. [caddyserver/caddy](https://github.com/caddyserver/caddy) - Fast and extensible multi-platform HTTP/1-2-3 web server with automatic HTTPS (2 weeks ago)
1. [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) - Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs (2 weeks ago)
...
- [pepperoni21/ollama-rs](https://github.com/pepperoni21/ollama-rs) ([v0.2.5](https://github.com/pepperoni21/ollama-rs/releases/tag/v0.2.5), 2 days ago) - A simple and easy-to-use library for interacting with the Ollama API.
...
1. [pepperoni21/ollama-rs](https://github.com/pepperoni21/ollama-rs) ([v0.2.5](https://github.com/pepperoni21/ollama-rs/releases/tag/v0.2.5), 2 days ago) - A simple and easy-to-use library for interacting with the Ollama API.
