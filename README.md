...
1. [ratatui/awesome-ratatui](https://github.com/ratatui/awesome-ratatui) (1 week ago)
...
- [Lommix/bevy_hui](https://github.com/Lommix/bevy_hui) - Component based UI crate using Xml/Html with focus on hot reload for the bevy engine. (1 week ago)
- [rust-lang/async-book](https://github.com/rust-lang/async-book) - Asynchronous Programming in Rust (1 week ago)

<details><summary>more...</summary>

1. [Lommix/bevy_hui](https://github.com/Lommix/bevy_hui) - Component based UI crate using Xml/Html with focus on hot reload for the bevy engine. (1 week ago)
1. [rust-lang/async-book](https://github.com/rust-lang/async-book) - Asynchronous Programming in Rust (1 week ago)
1. [longbridge/gpui-component](https://github.com/longbridge/gpui-component) - UI components write in GPUI. (2 weeks ago)
1. [emilk/eframe_template](https://github.com/emilk/eframe_template) - The easy way to make a Rust app with a GUI (2 weeks ago)
1. [rhysd/tui-textarea](https://github.com/rhysd/tui-textarea) - Simple yet powerful multi-line text editor widget for ratatui and tui-rs (3 weeks ago)
1. [notify-rs/notify](https://github.com/notify-rs/notify) - 🔭 Cross-platform filesystem notification library for Rust.  (3 weeks ago)
1. [ratatui/ratatui](https://github.com/ratatui/ratatui) - A Rust crate for cooking up terminal user interfaces (TUIs) 👨‍🍳🐀 https://ratatui.rs (3 weeks ago)
1. [pest-parser/pest](https://github.com/pest-parser/pest) - The Elegant Parser (3 weeks ago)
...
- [feat: upgrade SFML to 3.0.0](https://github.com/ShenMian/gomoku/pull/2) on [ShenMian/gomoku](https://github.com/ShenMian/gomoku) (1 day ago)
- [build(deps): update bevy to v0.15](https://github.com/ShenMian/sokoban-rs/pull/15) on [ShenMian/sokoban-rs](https://github.com/ShenMian/sokoban-rs) (1 week ago)
- [tracker: Add version 0.1.1](https://github.com/ScoopInstaller/Extras/pull/14548) on [ScoopInstaller/Extras](https://github.com/ScoopInstaller/Extras) (1 week ago)

<details><summary>more...</summary>

1. [feat: upgrade SFML to 3.0.0](https://github.com/ShenMian/gomoku/pull/2) on [ShenMian/gomoku](https://github.com/ShenMian/gomoku) (1 day ago)
1. [build(deps): update bevy to v0.15](https://github.com/ShenMian/sokoban-rs/pull/15) on [ShenMian/sokoban-rs](https://github.com/ShenMian/sokoban-rs) (1 week ago)
1. [tracker: Add version 0.1.1](https://github.com/ScoopInstaller/Extras/pull/14548) on [ScoopInstaller/Extras](https://github.com/ScoopInstaller/Extras) (1 week ago)
1. [Add tracker](https://github.com/ratatui/awesome-ratatui/pull/107) on [ratatui/awesome-ratatui](https://github.com/ratatui/awesome-ratatui) (2 weeks ago)
1. [Fix rapid and continuous movement issue](https://github.com/ShenMian/sokoban-rs/pull/14) on [ShenMian/sokoban-rs](https://github.com/ShenMian/sokoban-rs) (2 weeks ago)
...
- [jomaway/typst-gentle-clues](https://github.com/jomaway/typst-gentle-clues) ([v1.1.0](https://github.com/jomaway/typst-gentle-clues/releases/tag/v1.1.0), 1 week ago) - Simple admonishment for typst
- [ShenMian/tracker](https://github.com/ShenMian/tracker) ([v0.1.2](https://github.com/ShenMian/tracker/releases/tag/v0.1.2), 1 week ago) - A terminal-based real-time satellite tracking and orbit prediction application.
...
1. [jomaway/typst-gentle-clues](https://github.com/jomaway/typst-gentle-clues) ([v1.1.0](https://github.com/jomaway/typst-gentle-clues/releases/tag/v1.1.0), 1 week ago) - Simple admonishment for typst
1. [ShenMian/tracker](https://github.com/ShenMian/tracker) ([v0.1.2](https://github.com/ShenMian/tracker/releases/tag/v0.1.2), 1 week ago) - A terminal-based real-time satellite tracking and orbit prediction application.
