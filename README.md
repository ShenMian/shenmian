...
- [immersive-translate/immersive-translate](https://github.com/immersive-translate/immersive-translate) - Immersive Dual Web Page Translation Extension - 沉浸式双语网页翻译扩展  (3 days ago)
...
1. [immersive-translate/immersive-translate](https://github.com/immersive-translate/immersive-translate) - Immersive Dual Web Page Translation Extension - 沉浸式双语网页翻译扩展  (3 days ago)
1. [files-community/Files](https://github.com/files-community/Files) - Building the best file manager experience for Windows (3 days ago)
1. [lencx/ChatGPT](https://github.com/lencx/ChatGPT) - 🔮 ChatGPT Desktop Application (Mac, Windows and Linux) (4 days ago)
1. [lihongxun945/gobang](https://github.com/lihongxun945/gobang) - javascript gobang AI，JS五子棋AI，源码&#43;教程，基于Alpha-Beta剪枝算法（不是神经网络） (4 days ago)
1. [lihongxun945/myblog](https://github.com/lihongxun945/myblog) - 言川的博客-前端工程师的笔记 (4 days ago)
1. [dice2o/BingGPT](https://github.com/dice2o/BingGPT) - Desktop application of new Bing&#39;s AI-powered chat (Windows, macOS and Linux) (6 days ago)
...
- [refactor(editor): adjust menu item names](https://github.com/BoomingTech/Piccolo/pull/444) on [BoomingTech/Piccolo](https://github.com/BoomingTech/Piccolo) (2 days ago)
- [feat: the waiting part can continue to move the cursor](https://github.com/ShenMian/gomoku/pull/1) on [ShenMian/gomoku](https://github.com/ShenMian/gomoku) (5 days ago)
...
1. [refactor(editor): adjust menu item names](https://github.com/BoomingTech/Piccolo/pull/444) on [BoomingTech/Piccolo](https://github.com/BoomingTech/Piccolo) (2 days ago)
1. [feat: the waiting part can continue to move the cursor](https://github.com/ShenMian/gomoku/pull/1) on [ShenMian/gomoku](https://github.com/ShenMian/gomoku) (5 days ago)
...
- [SpaceVim/SpaceVim](https://github.com/SpaceVim/SpaceVim) ([v2.1.0](https://github.com/SpaceVim/SpaceVim/releases/tag/v2.1.0), 3 days ago) - A community-driven modular vim/neovim distribution - The ultimate vimrc
...
1. [SpaceVim/SpaceVim](https://github.com/SpaceVim/SpaceVim) ([v2.1.0](https://github.com/SpaceVim/SpaceVim/releases/tag/v2.1.0), 3 days ago) - A community-driven modular vim/neovim distribution - The ultimate vimrc
