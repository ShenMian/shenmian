...
- [simply-logical/simply-logical](https://github.com/simply-logical/simply-logical) - Online, interactive edition of the &#34;Simply Logical&#34; Prolog textbook (1 day ago)

- [rikkahub/rikkahub](https://github.com/rikkahub/rikkahub) - RikkaHub is a Android APP that supports for multiple LLM providers. (1 day ago)

<details><summary>more...</summary>

1. [simply-logical/simply-logical](https://github.com/simply-logical/simply-logical) - Online, interactive edition of the &#34;Simply Logical&#34; Prolog textbook (1 day ago)
1. [rikkahub/rikkahub](https://github.com/rikkahub/rikkahub) - RikkaHub is a Android APP that supports for multiple LLM providers. (1 day ago)
1. [microg/GmsCore](https://github.com/microg/GmsCore) - Free implementation of Play Services (2 days ago)
...
- [ShenMian/tracker](https://github.com/ShenMian/tracker) ([v0.1.7](https://github.com/ShenMian/tracker/releases/tag/v0.1.7), 1 day ago) - A terminal-based real-time satellite tracking and orbit prediction application.
...
1. [ShenMian/tracker](https://github.com/ShenMian/tracker) ([v0.1.7](https://github.com/ShenMian/tracker/releases/tag/v0.1.7), 1 day ago) - A terminal-based real-time satellite tracking and orbit prediction application.
